...
class ReAssignIssueDialog extends StatefulWidget {
  final String issueId;
  final String businessId;
  final BuildContext prevContext;

  ReAssignIssueDialog({required this.issueId , required this.businessId , required this.prevContext});

  @override
  _ReAssignIssueDialogState createState() => _ReAssignIssueDialogState();
}

class _ReAssignIssueDialogState extends State<ReAssignIssueDialog> {
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    if (selectedUserListItem != null) {
                      ...
                      issueController.reassignIssueRequest(widget.prevContext, widget.businessId, widget.issueId, selectedUserListItem!.userId!);
                      GoRouter.of(context).pop(); // Close the dialog
                    }
                  },
                  child: Text("Submit"),
