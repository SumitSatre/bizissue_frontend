...
class _IssuePageState extends State<IssuePage> {
  ...
  void initState() {
    ...
    socket = IO.io('https://bizissue-backend.onrender.com/issue/chat', <String, dynamic>{
                  ...
                  children: [
                    ...
                    Column(
                      children: issueController.messages?.map((message) {
                        bool isMe = message.sender.id == (homeController.userModel?.id ?? ""); // Example condition
                   ...
                   GestureDetector(
                     onTap: () {
                       ...
                       socket.emit('issue-message', {
                         ...
                         'message': {
                           'sender': {'id': homeController.userModel?.id ?? "", 'name':  homeController.userModel?.name ?? ""},
...
class ChatBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxWidth = MediaQuery.of(context).size.width * 0.8; // 80% of total mobile width
