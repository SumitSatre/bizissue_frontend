...
class MyAppBarOutsider extends StatelessWidget implements PreferredSizeWidget {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<OutsiderProvider>(builder: (context, ref, child) {
      return Padding(
                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          ref.outsiderInfo?.business?.name ?? "Business",
                          style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
                        ),
                        Text(
                          ref.outsiderInfo?.user?.role ?? "role",
                          style: TextStyle(),
                        ),
                      ],
                    ),
